...
class NotesService {
  ...
  Future<DatabaseNote> updateNote({
    ...
    if (updatesCount == 0) {
      ...
      _notes.removeWhere((localNote) => localNote.id == updatedNote.id);
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    // make sure owner exist in the db with correct email
...
// second value is database column name id / user_id etc
...
const isSyncedWithCloudColumn = 'is_syncyed_with_cloud';
